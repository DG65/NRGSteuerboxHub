<?php
/**
 * check-standalone.php — Prüft die Eigenständigkeit dieses Moduls (SteuerboxHub).
 *
...
// Präfixe der Partnermodule. SBH ist der EIGENE Präfix dieses Repos
// und gehören daher NICHT in die Liste — sonst meldet das Skript die eigenen
// Funktionen als ungeschützte Fremdaufrufe.
const FOREIGN_PREFIXES = ['IHUB', 'IHUBD', 'IHUBNRG', 'IHUBMON', 'IHUBTILE', 'MHUB', 'MHUBD', 'CHUB', 'MIGHUB', 'PVF', 'LFC', 'HEISHA', 'SGW', 'TIBBERGR', 'TESSIE', 'EMS', 'GWET'];
